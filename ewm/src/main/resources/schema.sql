DROP TABLE IF EXISTS categories, users, locations, events, requests, compilations, compilation_event, comments CASCADE;
...
(
    ...
    CONSTRAINT fk_event_to_comments FOREIGN KEY (event_id) REFERENCES events (id),
    CONSTRAINT fk_user_to_comments FOREIGN KEY (author_id) REFERENCES users (id)
);